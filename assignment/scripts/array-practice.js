...
let favFoods = ['Tacos','Pancakes','Gyros','Strombolis','Omelletes','Chicken']
...
console.log('My array has:', favFoods.length + ' items.');
...
favFoods.push('Pizza');
console.log('Added a favorite food to the end', favFoods);
...
console.log('Removed the last food', removedFood +'. Updated array:',favFoods);
...
favFoods.unshift('Lasagna');
console.log('Added', favFoods[0] + ' to the beginning of array. Updated array:', favFoods);
